			...
			switch ( $setting['type'] ) {
				...
				case 'image' :
					...
					<p>
						...
						<input type="url" style="margin:5px 0;" class="widefat jobify-widget-media-input" name="<?php echo esc_attr( $this->get_field_name( $key ) ); ?>" value="<?php echo esc_attr( $value ); ?>" placeholder="http://" />
