...
<form id="astoundify-content-importer" action="" method="">
	...
	<div id="content-pack">
		<p style="margin: 30px 0 0 -15px">
			...
			<label for="skin-1" class="content-pack">
				<span class="content-pack-label">Skin 1</span>
				<input type="radio" value="skin-1" name="demo_style" id="skin-1" />
				<span class="content-pack-img">
					<span class="dashicons dashicons-yes"></span>
					<img src="<?php echo get_template_directory_uri(); ?>/inc/setup/assets/images/content-skin-1.png" />
				</span>
				<span class="screen-reader-text"><?php _e( 'Skin 1...', 'jobify' ); ?></span>
			</label>
		</p>
	</div>
