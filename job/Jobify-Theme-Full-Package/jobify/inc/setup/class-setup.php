...
<?php
	...
	public static function plugin_installer() {
		astoundify_plugininstaller( array(
			'plugins' => array( 'wp-job-manager', 'woocommerce', 'wp-job-manager-companies', 'wp-job-manager-colors', 'wp-job-manager-locations', 'wp-job-manager-contact-listing', 'woocommerce-simple-registration', 'ninja-forms', 'elementor', 'newsletter', 'if-menu' ),
			'forceActivate' => true,
			'l10n' => array(
	...
	public static function set_recommended_plugins() {
		return array(
			...
			'wp-job-manager-regions' => array(
				...
				'pack' => array( 'classic', 'extended', 'skin-1' ),
			),
			...
			'woothemes-testimonials' => array(
				'label' => '<a href="' . admin_url( 'themes.php?page=tgmpa-install-plugins' ) . '">Testimonials</a>',
				'condition' => class_exists( 'Woothemes_Testimonials' ),
				'pack' => array( 'classic', 'extended', 'skin-1' ),
			),
			'elementor' => array(
				'label' => '<a href="' . admin_url( 'plugin-install.php?tab=plugin-information&plugin=elementor&TB_iframe=true&width=772&height=642' ) . '" class="thickbox">Elementor</a>',
				'condition' => defined( 'ELEMENTOR_VERSION' ),
				'pack' => array( 'skin-1' ),
			),
			'newsletter' => array(
				'label' => '<a href="' . admin_url( 'plugin-install.php?tab=plugin-information&plugin=newsletter&TB_iframe=true&width=772&height=642' ) . '" class="thickbox">Newsletter</a>',
				'condition' => defined( 'ELEMENTOR_VERSION' ),
				'pack' => array( 'skin-1' ),
			)
		);
