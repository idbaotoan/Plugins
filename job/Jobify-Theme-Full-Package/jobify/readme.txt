...
Jobify is distributed under the terms of the GNU GPL.
...
= 3.19.0: March 25th, 2021 =
* Add: jobify new skin-1
* Add: Created elementor pages with new skin-1
* Fix: Demo import halts during the import process.
* Updates: Jobs single pages.
* Fix: PHP warning related widgets in elementor.
* Fix: PHP warning for jobify widgets compatibility.
* Fix: Maintenance changes.

= 3.18.0: January 29, 2021 =
