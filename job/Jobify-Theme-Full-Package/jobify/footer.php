...
?>
		...
		<?php $style = get_option( 'stylesheet' ); 
		...
		<footer id="colophon" class="site-footer <?php echo ($style)?'skin-1-footer':''; ?>" role="contentinfo">
				...
				<div class="container">
					<div class="row">
						...
						if($style == 'jobify-skin-1')
						{
							...
							<div class="col-xs-12 col-md-6 col-lg-<?php echo $coldata; ?>">
